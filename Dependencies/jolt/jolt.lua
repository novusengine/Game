...
Solution.Util.CreateStaticLib(dep.Name, Solution.Projects.Current.BinDir, dep.Dependencies, function()
    ...
    local files =
    {
        ...
        sourceDir .. "/ConfigurationString.h",
        sourceDir .. "/Compute/ComputeBuffer.h",
        sourceDir .. "/Compute/ComputeQueue.h",
        sourceDir .. "/Compute/ComputeSystem.cpp",
        sourceDir .. "/Compute/ComputeSystem.h",
        sourceDir .. "/Compute/ComputeShader.h",
        sourceDir .. "/Core/ARMNeon.h",
        sourceDir .. "/Core/RISCVVector.h",
        sourceDir .. "/Core/Array.h",
        sourceDir .. "/Core/Atomics.h",
        sourceDir .. "/Core/BinaryHeap.h",
        ...
        sourceDir .. "/Core/HashTable.h",
        sourceDir .. "/Core/IncludeWindows.h",
        ...
        sourceDir .. "/Core/LSANSuppressions.h",
        ...
        sourceDir .. "/Core/ObjectToIDMap.h",
        sourceDir .. "/Core/Prefetch.h",
        ...
        sourceDir .. "/Core/STLLocalAllocator.h",
        ...
        sourceDir .. "/Core/UnorderedMapFwd.h",
        sourceDir .. "/Core/UnorderedSet.h",
        sourceDir .. "/Core/UnorderedSetFwd.h",
        ...
        sourceDir .. "/Jolt.h",
        sourceDir .. "/Math/BVec16.h",
        sourceDir .. "/Math/BVec16.inl",
        ...
        sourceDir .. "/Physics/Character/CharacterID.h",
        ...
        sourceDir .. "/Physics/Collision/BroadPhase/BroadPhaseLayerInterfaceMask.h",
        sourceDir .. "/Physics/Collision/BroadPhase/BroadPhaseLayerInterfaceTable.h",
        ...
        sourceDir .. "/Physics/Collision/BroadPhase/ObjectVsBroadPhaseLayerFilterMask.h",
        sourceDir .. "/Physics/Collision/BroadPhase/ObjectVsBroadPhaseLayerFilterTable.h",
        ...
        sourceDir .. "/Physics/Collision/CollideShapeVsShapePerLeaf.h",
        sourceDir .. "/Physics/Collision/CollideSoftBodyVertexIterator.h",
        sourceDir .. "/Physics/Collision/CollideSoftBodyVerticesVsTriangles.h",
        ...
        sourceDir .. "/Physics/Collision/InternalEdgeRemovingCollector.h",
        ...
        sourceDir .. "/Physics/Collision/ObjectLayerPairFilterMask.h",
        sourceDir .. "/Physics/Collision/ObjectLayerPairFilterTable.h",
        ...
        sourceDir .. "/Physics/Collision/Shape/EmptyShape.cpp",
        sourceDir .. "/Physics/Collision/Shape/EmptyShape.h",
        ...
        sourceDir .. "/Physics/Collision/Shape/PlaneShape.cpp",
        sourceDir .. "/Physics/Collision/Shape/PlaneShape.h",
        ...
        sourceDir .. "/Physics/Collision/Shape/TaperedCylinderShape.cpp",
        sourceDir .. "/Physics/Collision/Shape/TaperedCylinderShape.h",
        ...
        sourceDir .. "/Physics/Collision/SimShapeFilter.h",
        sourceDir .. "/Physics/Collision/SimShapeFilterWrapper.h",
        ...
        sourceDir .. "/Physics/Constraints/CalculateSolverSteps.h",
        ...
        sourceDir .. "/Physics/Constraints/ConstraintPart/AngularFrictionConstraintPart.h",
        sourceDir .. "/Physics/Constraints/ConstraintPart/AxisConstraintPart.h",
        sourceDir .. "/Physics/Constraints/ConstraintPart/ContactConstraintPart.h",
        ...
        sourceDir .. "/Physics/Hair/Hair.cpp",
        sourceDir .. "/Physics/Hair/Hair.h",
        sourceDir .. "/Physics/Hair/HairSettings.cpp",
        sourceDir .. "/Physics/Hair/HairSettings.h",
        sourceDir .. "/Physics/Hair/HairShaders.cpp",
        sourceDir .. "/Physics/Hair/HairShaders.h",
        sourceDir .. "/Physics/Hair/RegisterHair.cpp",
        sourceDir .. "/Physics/Hair/RegisterHair.h",
        ...
        sourceDir .. "/Physics/SoftBody/SoftBodyUpdateContext.h",
        ...
        sourceDir .. "/Renderer/DebugRendererSimple.cpp",
        sourceDir .. "/Renderer/DebugRendererSimple.h",
