...
local mod = Solution.Util.CreateModuleTable("Game-Lib", { "renderer", "fileformat", "filesystem", "scripting", "gameplay", "input", "meta", "luau-analysis", "luau-compiler", "luau-vm", "luau-codegen", "enkits", "utfcpp", "base64", "jolt", "spake2-ee" })
