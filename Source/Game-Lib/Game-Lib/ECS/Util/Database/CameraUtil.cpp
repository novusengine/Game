...
namespace ECS
{
    namespace Util::Database::Camera
    {
        bool Refresh()
        {
            ...
            if (!ctx.find<Singletons::Database::CameraSaveSingleton>())
                ctx.emplace<Singletons::Database::CameraSaveSingleton>();
            ...
            auto& cameraSaveSingleton = ctx.get<Singletons::Database::CameraSaveSingleton>();
            auto* cameraSaveStorage = clientDBSingleton.Get(ClientDBHash::CameraSave);
