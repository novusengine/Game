...
namespace ECS::Singletons
{
    ...
    struct CharacterUnsupportedState
    {
    public:
        f32 elapsedFallTime = 0.0f;
        f32 elapsedFallDistance = 0.0f;
    };

    enum class CharacterGroundMovementMode : u8
    {
        Walk,
        Unsupported,
        Fall
    ...
    public:
        ...
        f32 unsupportedElapsedFallTime = 0.0f;
        f32 unsupportedElapsedFallDistance = 0.0f;
    };
    ...
    public:
        ...
        f32 walkStairsStepDownExtra = 0.5f;
        ...
        f32 fallCommitDistance = 1.0f / 9.0f;
        f32 fallCommitTime = 0.5f;
    ...
    public:
        ...
        CharacterGroundMovementMode groundMovementMode = CharacterGroundMovementMode::Fall;
        ...
        CharacterUnsupportedState unsupportedState;
    };

    static_assert(sizeof(CharacterMovementIntent) == sizeof(u8));
    static_assert(sizeof(CharacterControlMask) == sizeof(u8));
    static_assert(sizeof(CharacterUnsupportedState) <= 32);
    static_assert(sizeof(CharacterControllerDebugSingleton) <= 168);
    static_assert(sizeof(CharacterControllerSettings) <= 128);
    static_assert(sizeof(CharacterControllerSingleton) <= 72);
}
