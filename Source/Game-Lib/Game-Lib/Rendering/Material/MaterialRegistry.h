...
namespace MaterialLoading
{
    ...
    {
      public:
        MaterialRegistry(PACT::PactStorage* pactStorage, MaterialStorage* storage, ModelTextureResolver* textureResolver);
      ...
      private:
        ...
        ModelTextureResolver* _textureResolver = nullptr;
